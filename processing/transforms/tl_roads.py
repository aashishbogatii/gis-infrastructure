"""Census TIGER/Line Primary Roads

Reads the primary-roads line shapefile straight from *inside the zip* via
...
ZIP_GLOB = "tl_*_us_primaryroads.zip"
...
def transform(*, source_uri: str, config: dict) -> gpd.GeoDataFrame:
    ...
    # Shapefile is named like the zip stem, e.g. tl_2025_us_primaryroads.shp
